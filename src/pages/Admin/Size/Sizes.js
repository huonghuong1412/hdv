...
import { getAllSize, deleteSize, addSize, updateSize, checkCode } from '../../../actions/SizeService';
...
function Sizes(props) {
    ...
    const saveOrUpdate = () => {
        ...
        checkCode(id, name)
            .then((res) => {
                if (res.data) {
                    toast.error("Tên kích thước đã có tồn tại")
                } else {
                    if (id) {
                        updateSize({
                            ...author,
                                                            ...
                                                            <td>
                                                                ...
                                                                >
                                                                    <DialogTitle id="alert-dialog-title">
                                                                        Chắc chắn xoá kích thước này? + {id}
                                                                    </DialogTitle>
                                                                    <DialogActions>
