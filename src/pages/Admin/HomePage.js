...
export default class HomePage extends Component {
    render() {
        return (
            <>
                <div className="content-wrapper" style={{ minHeight: '926px' }}>
                    ...
                    <section className="content">
                                    ...
                                    <div className="box-body">
                                        <div className="row">
                                            <div className="col-md-8">
                                                ...
                                                <div className="chart">
                                                    {/* Sales Chart Canvas */}
                                                    <canvas id="salesChart" style={{ height: '180px', width: '703px' }} height={180} width={703} />
                                                </div>
                                                {/* /.chart-responsive */}
                                            </div>
                                            {/* /.col */}
                                            ...
                                            <div className="col-md-3 col-sm-4">
                                                <div className="pad box-pane-right bg-green" style={{ minHeight: '280px' }}>
                                                    <div className="description-block margin-bottom">
                                                        <div className="sparkbar pad" data-color="#fff"><canvas width={34} height={30} style={{ display: 'inline-block', width: '34px', height: '30px', verticalAlign: 'top' }} /></div>
                                            ...
                                            <div className="box-body">
                                                ...
                                                <div className="direct-chat-messages">
                                                    ...
                                                    <div className="direct-chat-msg">
                                                        ...
                                                        {/* /.direct-chat-info */}
                                                        <img className="direct-chat-img" src="/images/1.png" alt="message user image" />
                                                        {/* /.direct-chat-img */}
                                            ...
                                            <table className="table no-margin">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div className="sparkbar" data-color="#00a65a" data-height={20}><canvas width={34} height={20} style={{ display: 'inline-block', width: '34px', height: '20px', verticalAlign: 'top' }} /></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div className="sparkbar" data-color="#f39c12" data-height={20}><canvas width={34} height={20} style={{ display: 'inline-block', width: '34px', height: '20px', verticalAlign: 'top' }} /></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div className="sparkbar" data-color="#f56954" data-height={20}><canvas width={34} height={20} style={{ display: 'inline-block', width: '34px', height: '20px', verticalAlign: 'top' }} /></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="pages/examples/invoice.html">OR7429</a></td>
                                                        ...
                                                        <td>
                                                            <div className="sparkbar" data-color="#00c0ef" data-height={20}><canvas width={34} height={20} style={{ display: 'inline-block', width: '34px', height: '20px', verticalAlign: 'top' }} /></div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><a href="pages/examples/invoice.html">OR1848</a></td>
                                        ...
                                        <div className="row">
                                            <div className="col-md-8">
                                                <div className="chart-responsive">
                                                    <canvas id="pieChart" height={160} width={205} style={{ width: '205px', height: '160px' }} />
                                                </div>
                                                {/* ./chart-responsive */}
                                            </div>
                                            {/* /.col */}
                        ...
                        <span className="pull-right text-yellow"><i className="fa fa-angle-left" /> 0%</span></a></li>
                          ...
                          <span className="label label-success pull-right">$399</span></a>
                                    ...
                                    {/* /.box-body */}
                                    <div className="box-footer text-center">
                                        <Link to="#" className="uppercase">View All Products</Link>
                                    </div>
                                    {/* /.box-footer */}
                                </div>
                                {/* /.box */}
