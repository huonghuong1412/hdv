...
import { getAllBrand, deleteBrand, addBrand, updateBrand, checkCode } from '../../../actions/BrandService.';
...
function Brands(props) {
    ...
    const saveOrUpdate = () => {
        ...
        checkCode(id, name)
            .then((res) => {
                if (res.data) {
                    toast.error("Tên thương hiệu đã có tồn tại")
                } else {
                    if (id) {
                        updateBrand({
                            ...author,
    ...
    const handleDeleteCategory = (id) => {
        deleteBrand(id)
            ...
            .catch(err => {
                toast.error("Xoá Thương hiệu không thành công");
                console.log(err);
            })
        ...
        <>
                                                            ...
                                                            <td>
                                                                ...
                                                                >
                                                                    <DialogTitle id="alert-dialog-title">
                                                                        Chắc chắn xoá Thương hiệu này? + {id}
                                                                    </DialogTitle>
                                                                    <DialogActions>
            ...
            <Dialog open={openForm} onClose={handleCloseForm} aria-labelledby="form-dialog-title">
                <DialogTitle id="form-dialog-title">
                    {
                        _.isEmpty(item) === false ? "Thương hiệu" : "Thương hiệu"
                    }
                </DialogTitle>
